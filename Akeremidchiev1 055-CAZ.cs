...
namespace SeleniumTests
{
    ...
    // Login Failed Due To Incorrect Credentials/Wrong Username
    [TestClass]
    public class LoginFailedDueToIncorrectCredentialsWrongUsername
    {
        ...
        [TestMethod]
        public void TheLoginFailedDueToIncorrectCredentialsWrongUsernameTest()
        {   // Arange
            ...
            driver.FindElement(By.Id("username")).SendKeys("ilkopanev1913");
